...
class BapendaWebsite {
  ...
  animateElement(element) {
    const animationType =
      element.getAttribute('data-aos') || element.classList.contains('fade-in-left')
        ? 'fade-left'
  ...
  triggerEntranceAnimations() {
    ...
    const heroElements = ['.hero-badge', '.hero-title', '.hero-subtitle', '.hero-stats', '.hero-cta', '.scroll-indicator'];
